...
if __name__ == "__main__":
    ...
    input2 = torch.randn(1, 3, 64, 64).cuda()
    correlation_layer = Correlation(pad_size=3, kernel_size=3, max_displacement=20, stride1=1, stride2=2, corr_multiply=1).cuda()
    output = correlation_layer(input1, input2)
    print(output.shape)  # Output shape will depend on the parameters set