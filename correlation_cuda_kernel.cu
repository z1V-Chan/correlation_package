                                    ...
                                    cudaStream_t stream)
{
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.scalar_type(), "channels_first_bwd_1", ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input2.scalar_type(), "channels_first_bwd_2", ([&] {
